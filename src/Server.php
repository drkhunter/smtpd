...
class Server extends Thread
{
     ...
     */
    public function newMail(string $from, array $rcpt, Parser $mail, $authMethod, $credentials)
    {
        $this->eventExecute(Event::TRIGGER_NEW_MAIL, [$from, $rcpt, $mail, $authMethod, $credentials]);
    }
